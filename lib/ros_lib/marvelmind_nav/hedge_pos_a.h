#ifndef _ROS_marvelmind_nav_hedge_pos_a_h
#define _ROS_marvelmind_nav_hedge_pos_a_h
...
namespace marvelmind_nav
{
  ...
  class hedge_pos_a : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "marvelmind_nav/hedge_pos_a"; };
    virtual const char * getMD5() override { return "674512ab330b329e8180ed5adabac64b"; };
